-- Mise à jour avec des images HD pour toutes les catégories
UPDATE ai_tools 
...
-- Je vais continuer avec les autres catégories dans le prochain fichier pour ne pas surcharger celui-ci.
-- Voulez-vous que je continue avec les catégories restantes ?
